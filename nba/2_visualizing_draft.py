...
draft_df = pd.read_csv('/home/cc/draft_data_1996_to_2014.csv', index_col=0)
...
print draft_df[draft_df['Draft_Yr'] == 1996]['WS_per_48'].mean()
...
title = ('Average Career Win Shares Per 48 minutes by Draft Year (1996-2014)')
plt.title(title, fontsize=20)

plt.ylabel('Win Shares Per 48 minutes', fontsize=18)

plt.xlim(1996, 2014.5)
plt.ylim(0, 0.08)
...
print players_drafted

sns.set_style("white")
plt.figure(figsize=(12, 9))
x_values = draft_df.Draft_Yr.unique()
y_values = players_drafted
title = ('The Number of players Drafted in each Draft (1996-2014)')
plt.title(title, fontsize=20)
...
title = ('Average Career Win Shares Per 48 minutes for'
         '\nTop 60 Picks by Draft Year (1996-2014)')
plt.title(title, fontsize=20)
plt.ylabel('win shares per 48 minutes', fontsize=18)
plt.xlim(1996, 2014.5)
plt.ylim(0, 0.08)
...
title = ('Average Win Shares per 48 Minutes for each'
         '\nNBA Draft Pick in the Top 60 (1996-2014)')
